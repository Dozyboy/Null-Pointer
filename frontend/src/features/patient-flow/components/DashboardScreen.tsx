  ...
  const priorityOptions: { id: ScheduleStrategy; label: string; desc: string; icon: React.ReactNode; time: string }[] = [
    {
      id: "balanced",
      label: "Cân bằng",
      desc: "Cân bằng thời gian chờ, thời điểm có kết quả và việc di chuyển",
    ...
    },
    {
      ...
      desc: "Ưu tiên được tiếp nhận và hoàn thành các dịch vụ sớm; có thể chờ gặp lại bác sĩ lâu hơn",
      icon: <Timer size={18} />,
      time: estimatedDuration ?? "Đang tính",
    },
    {
      ...
      desc: "Sắp xếp để hoàn thành dịch vụ, có đủ kết quả và gặp lại bác sĩ sớm nhất",
