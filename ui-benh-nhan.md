...
| Ưu tiên trong thẻ Lịch trình | 3 lựa chọn | Cân bằng, Ưu tiên hoàn tất sớm, Ra khỏi viện nhanh nhất |
| Ưu tiên khi tạo phương án | 5 lựa chọn | Để hệ thống đề xuất, Hoàn tất sớm, Ít đi bộ, Khu chờ ít đông, Hỗ trợ di chuyển |
| Giá trị chọn sẵn | Hoàn tất sớm | Ghi rõ đây là lựa chọn mặc định của giao diện |
...
| Lựa chọn | Mô tả trên giao diện | Tổng thời gian minh họa |
|---|---|---:|
| Cân bằng | Tối ưu thời gian, quãng đường và sự ổn định | Khoảng 3,5 giờ |
| Ưu tiên hoàn tất sớm | Sắp xếp để lấy đủ kết quả và quay lại bác sĩ nhanh nhất | Khoảng 2,8 giờ |
| Ra khỏi viện nhanh nhất | Rút ngắn tổng thời gian từ lúc bắt đầu đến khi ra về | Khoảng 2,2 giờ |
...
Đây là nhóm lựa chọn dùng khi tạo ba phương án lộ trình. Nhóm này khác ba lựa chọn trong thẻ Lịch trình của Trang chủ.
...
- Nút Cập nhật nhu cầu hỗ trợ chưa mở biểu mẫu.
- Lựa chọn ưu tiên mới chỉ đổi dòng phụ trên màn hình sau; ba thẻ lộ trình chưa được sắp xếp lại theo lựa chọn.
...
## 6. Hai nhóm lựa chọn ưu tiên đang cùng tồn tại

Đây là điểm dễ gây nhầm nhất trong giao diện hiện tại.

| Vị trí | Số lựa chọn | Mục đích đang thể hiện | Giá trị mặc định |
|---|---:|---|---|
| Trang chủ → Lịch trình | 3 | Đổi cách nhìn và tổng thời gian minh họa của lịch trong ngày | Cân bằng |
| Luồng tạo phương án → Chọn điều ưu tiên | 5 | Chọn tiêu chí dùng để tạo lộ trình | Hoàn tất sớm |

Ba lựa chọn ở Trang chủ nhấn mạnh mốc kết thúc toàn hành trình. Năm lựa chọn trong luồng tạo phương án nhấn mạnh tổng thời gian, quãng đường, độ đông và khả năng tiếp cận.

Tài liệu ghi lại đúng giao diện hiện có, nhưng trước khi triển khai thật cần chọn một trong hai hướng:

1. Hợp nhất thành một bộ tiêu chí dùng ở mọi nơi.
2. Giữ hai bộ nhưng đổi tên và giải thích rõ: `Cách xem lịch hôm nay` và `Tiêu chí tạo lộ trình`.
...
- Màn hình Chọn điều ưu tiên có đúng năm lựa chọn và mặc định Hoàn tất sớm.
...
Tài liệu trước đây tập trung vào ba chế độ Cân bằng, Hoàn tất xét nghiệm sớm và Ra viện sớm. Giao diện trong thư mục `giaodien` đã mở rộng thành một ứng dụng đầy đủ hơn, có Trang chủ, Bản đồ, Kết quả, Thông báo, Hỗ trợ và hai nhóm lựa chọn ưu tiên khác nhau.
