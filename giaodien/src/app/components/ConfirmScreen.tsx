...
export function ConfirmScreen({ route, onBack, onConfirmed, onChooseAnother }: ConfirmScreenProps) {
  const [reservationSeconds, setReservationSeconds] = useState(120);
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
          ...
          {reservationSeconds <= 30 && (
            <div className="mt-2 pt-2 border-t border-amber-200">
              <button className="text-amber-700 underline" style={{ fontSize: 13 }}>
