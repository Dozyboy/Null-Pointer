...
| Chọn ưu tiên | Năm tiêu chí, mặc định Hoàn tất sớm | Chỉ đổi dòng mô tả, chưa xếp lại | FR-PREF |
| Chọn lộ trình | Ba phương án, chờ, quãng đường và lý do | Toàn bộ phương án cố định | FR-ROUTE |
| Chi tiết | Bốn bước, khóa lấy máu, phòng thay thế | Đổi phòng không truyền sang Xác nhận | FR-DETAIL |
| Giữ chỗ | Đồng hồ 120 giây, khóa khi hết hạn | Không gọi backend; gia hạn chưa hoạt động | FR-HOLD |
...
| Hỗ trợ | Xe lăn, thị giác, gọi, SMS, điểm hỗ trợ | Chưa tạo yêu cầu thật | FR-SUPPORT |
...
2. Lựa chọn ưu tiên chưa làm thay đổi lộ trình.
3. Phòng thay thế không được truyền xuyên suốt các màn hình.
...
12. Hồ sơ, chỉ định, hàng chờ, kết quả và trạng thái phòng đều chưa có API thật.
