...
| `finish_early` | Ưu tiên làm dịch vụ sớm | Đưa bệnh nhân vào các phòng có thể tiếp nhận sớm; thời gian chờ bác sĩ có thể dài hơn |
| `leave_fast` | Ưu tiên gặp bác sĩ chẩn đoán | Sắp xếp để bác sĩ có đủ các kết quả bắt buộc trong thời gian sớm nhất |
...
Trong bản giả lập, bệnh nhân có thể bấm **Tôi đã khám xong** và phải xác nhận lại trước khi chuyển bước. Thao tác này chỉ ghi tiến độ hành trình, không khẳng định kết quả chuyên môn đã sẵn sàng. Khi tích hợp bệnh viện thật, trạng thái chính thức phải được đối chiếu với nhân viên hoặc LIS/RIS/PACS.
